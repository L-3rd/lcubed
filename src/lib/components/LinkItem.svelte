...
<div class="relative w-72" style={link ? `height: ${link.offsetHeight}px;` : ""}>
  <div
    ...
    class="absolute left-2 top-2 w-72 border-2 border-gray-500"
  ...
  <a {href} {target}>
    <div
      bind:this={link}
      class="go-back absolute left-0 top-0 flex w-72 items-center justify-center border-2 border-gray-500 px-3 py-2 text-center"
